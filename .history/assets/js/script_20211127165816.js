...
var onStartQuiz = function(){
    ...
    document.getElementById("animal").value = currentQuestion.a
    document.getElementById("b").value = currentQuestion.b
    document.getElementById("c") = currentQuestion.c
    document.getElementById("d") = currentQuestion.d
