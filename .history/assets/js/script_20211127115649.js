...
var onStartQuiz = function(){
    ...
    // document.getElementById("button a").innerHTML = currentQuestion.a
    // document.getElementById("button b").innerHTML = currentQuestion.b
    // document.getElementById("button c").innerHTML = currentQuestion.c
    // document.getElementById("button d").innerHTML = currentQuestion.d
