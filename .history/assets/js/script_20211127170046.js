...
var onStartQuiz = function(){
    ...
    document.getElementById("animal").textContent = currentQuestion.a
    document.getElementById("b").textContent = currentQuestion.b
    document.getElementById("c").textContext = currentQuestion.c
    document.getElementById("d").textContext = currentQuestion.d
